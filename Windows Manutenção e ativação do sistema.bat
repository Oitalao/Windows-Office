...
echo 5. Programas Basicos
echo 6. Otimizacao do Desempenho do Sistema
echo 7. Sair
echo =======================
...
if %op%==5 goto programas_basicos
if %op%==6 goto otimizacao_desempenho
if %op%==7 goto sair
...
echo Executando a ferramenta Windows Malicious Software Removal Tool...
mrt /F /Q

echo Verificando e instalando atualizações do Windows...
...
echo Instalando Adobe Acrobat Reader DC...
winget install -e --id Adobe.Acrobat.Reader.64-bit

echo Todos os programas basicos foram instalados!
pause
goto menu
...
cls
echo =======================
echo OTIMIZACAO DO DESEMPENHO DO SISTEMA
echo =======================
echo 1. Desabilitar serviços desnecessarios
echo 2. Ajustar configuracoes de energia
echo 3. Habilitar modo de desempenho maximo
echo 4. Voltar ao menu
echo =======================
set /p op4="Escolha uma opcao: "

if %op4%==1 goto desabilitar_servicos
if %op4%==2 goto ajustar_energia
if %op4%==3 goto desempenho_maximo
if %op4%==4 goto menu

:desabilitar_servicos
echo Desabilitando serviços desnecessarios...
...
pause
goto otimizacao_desempenho

:ajustar_energia
echo Ajustando configuracoes de energia para alto desempenho...
...
:desempenho_maximo
echo Habilitando modo de desempenho maximo...
powercfg /duplicatescheme e9a42b02-d5df-448d-aa00-03f14749eb61
powercfg /setactive e9a42b02-d5df-448d-aa00-03f14749eb61
echo Modo de desempenho máximo habilitado!
pause
goto otimizacao_desempenho
